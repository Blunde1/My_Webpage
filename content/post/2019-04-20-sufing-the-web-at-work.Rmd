...
In my [previous post](https://berentlunde.netlify.com/post/2019-04-19-bessel-function/), I mentioned my friend and previous co-worker at Tryg, [Ole Schei](https://www.linkedin.com/in/ole-schei-27674211/), that is wonderfully maticious, and has for some time quantified aspects of his life in a time-series format.
...
cols <- c("Estimated stochastic intensity"="black", 
          ...
          "Constant Poisson intensity" = "green",
